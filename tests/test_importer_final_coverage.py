...
def test_import_data_force_create_path():
    ...
    try:
        with patch("odoo_data_flow.importer._count_lines", return_value=3):
            with patch("odoo_data_flow.importer._run_preflight_checks") as mock_preflight:
                ...
                with patch("odoo_data_flow.importer.sort.sort_for_self_referencing") as mock_sort:
    ...
    try:
        with patch("odoo_data_flow.importer._count_lines", return_value=4):
            with patch("odoo_data_flow.importer._run_preflight_checks", return_value=True):
                with patch("odoo_data_flow.importer.import_threaded.import_data") as mock_import:
                    mock_import.return_value = (True, {"id_map": {"1": 101, "2": 102, "3": 103}})
