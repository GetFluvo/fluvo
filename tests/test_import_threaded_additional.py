...
def test_convert_external_id_field() -> None:
    ...
    base_name, value = _convert_external_id_field(mock_model, "parent_id/id", "external.id")
    ...
    base_name, value = _convert_external_id_field(mock_model, "parent_id/id", "invalid.id")
    assert base_name == "parent_id"
    assert value is None
