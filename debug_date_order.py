...
# Load connection
connection = conf_lib.get_connection_from_config('/home/bosd/doodba/sps_12_18_so/conf/source_12_prod.conf')
...
if ids:
    ...
    for record in records:
        ...
        print(f"  date_order: {record.get('date_order')} (type: {type(record.get('date_order'))})")
